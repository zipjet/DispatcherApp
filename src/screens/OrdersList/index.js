                ...
                <View style={ContentCentered}>
                    <View>
                        ...
                        <View style={ContentRow}>
                            ...
                            <Text style="">
                                {this.state.tasks.filter((task) => { return task.meta.skockedAtHub === true && task.meta.bags.length === task.meta.scannedAtHub.length}).length}
                                /
                                {this.state.tasks.filter((task) => { return task.meta.skockedAtHub === true}).length}
                            </Text>
                        </View>
                        ...
                        <View style={ContentRow}>
                            <Text style="">New</Text>
                            <Text style="">
                                {this.state.tasks.filter((task) => { return task.meta.skockedAtHub === false && task.meta.bags.length === task.meta.scannedAtHub.length}).length}
                                /
                                {this.state.tasks.filter((task) => { return task.meta.skockedAtHub === false && (task.meta.scannedAtHub.length === 0 || task.meta.bags.length === task.meta.scannedAtHub.length)}).length}
                            </Text>
                        </View>
                        ...
                        <View style={ContentRow}>
                            ...
                            <Text style="">
                                {this.state.tasks.filter((task) => { return task.meta.skockedAtHub === false && task.meta.scannedAtHub.length > 0 && task.meta.scannedAtHub.length !== task.meta.bags.length }).length}
                            </Text>
                        </View>
